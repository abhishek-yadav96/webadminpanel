...
class UploadnewIndustryProvider with ChangeNotifier {
  String? message;
  final String apiUrl = 'http://ec2-65-0-8-136.ap-south-1.compute.amazonaws.com/api/v1/admin/upload/new/industry-info';
  ...
  Future<void> pickXlsxFile() async {
    ...
    if (result != null && result.files.single.bytes != null) {
      ...
      if (uploadSuccess) {
        message = 'Industry data uploaded successfully';
      } else {
