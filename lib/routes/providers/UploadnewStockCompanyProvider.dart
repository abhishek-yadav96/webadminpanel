...
class UploadnewStockCompanyProvider with ChangeNotifier {
  String? message;
  final String apiUrl = 'http://ec2-65-0-8-136.ap-south-1.compute.amazonaws.com/api/v1/admin/upload/new/stock-company-info';
