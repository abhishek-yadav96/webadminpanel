...
class AddNewsCategoryProvider extends ChangeNotifier {
  String _title = '';
  String? _message;
  String? _error;
  ...
  Future<void> addCorporateAction() async {
    final url = 'http://ec2-65-0-8-136.ap-south-1.compute.amazonaws.com/api/v1/admin/add-new/news/category';
